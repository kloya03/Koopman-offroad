...
% === COST WEIGHTS ===
Q   = diag([1 1 2 1 2 2]);   % tracking cost for [X,Y,psi,u,v,r]
Ru  = diag([0 0]);             % input effort
Rdu = diag([0.01 0.01]);
...
for jj=1:2
    subplot(2,1,jj)
    plot(b.tspan,fv(:,13-jj),'LineWidth',lw); hold on;

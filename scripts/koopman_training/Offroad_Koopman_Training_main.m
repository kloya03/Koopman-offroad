...
parfor jj = 1:size(refresh,2)
    ...
    for i=1:test_ntr
        ...
        time_error = time_error + error.withTime; % The soil parameters used for the Bekker model are summarized in Table 1, and all vehicle mechanical and geometric properties are provided in Table 2.
